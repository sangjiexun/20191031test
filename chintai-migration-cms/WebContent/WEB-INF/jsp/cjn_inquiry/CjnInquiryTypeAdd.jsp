...
<%@ include file="../parts/ContentsHeadline.jsp" %>
  <div class="main_layout">
    ...
    <html:form action="/cjn_inquiry/CjnInquiryTypeAddConfirm" method="post" onsubmit="disableSubmit(this);">
      <div class="add_form">
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <textarea name="adminNote" cols="60" rows="5">${fn:escapeXml(view.adminNote)}</textarea>
        </div>
      </div>            
      <div class="add_form">
        <input type="submit" value="確認画面へ">
        <input type="button" value="戻る" onClick="_submit('CjnInquiryTypeList.do')">
      </div>
    </html:form>
  </div>
</div>
