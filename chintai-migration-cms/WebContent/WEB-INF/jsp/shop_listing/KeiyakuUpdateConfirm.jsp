...
<c:set var="title" value="契約情報更新確認" />
...
<%@ include file="parts/ShopBasicInfo.jsp" %>
    ...
    <html:form action="/shop_listing/KeiyakuUpdateComplete">
    <!-- 契約情報 -->
<%@ include file="parts/KeiyakuInfoConfirm.jsp" %>
      ...
      <p>
        ...
        <input type="button" name="back" value="戻る" onClick="_submit('KeiyakuUpdatePageBack.do')">
      </p>
    </html:form>
