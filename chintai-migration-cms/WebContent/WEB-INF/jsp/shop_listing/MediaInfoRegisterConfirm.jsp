...
<c:set var="title" value="出稿情報（仮保存）登録確認" />
...
<%@ include file="../parts/PopUpContentsHeadline.jsp" %>
  <div class="popup_layout">
    ...
    <html:form action="/shop_listing/MediaRegisterComplete">
    <!-- 店舗コード -->
...
<c:forEach items="${view.listingIconInfos}" var="listing">
        ...
        <tr>
          <th rowspan="3" align="center" class="text-left">注釈</th>
      ...
      <p>
        ...
        <input type="button" name="back" value="戻る" onclick="_submit('MediaInfoRegisterPageBack.do')">
      </p>
    </html:form>
