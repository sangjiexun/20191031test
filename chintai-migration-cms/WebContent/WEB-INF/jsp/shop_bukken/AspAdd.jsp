...
<%@ include file="../parts/PopUpContentsHeadline.jsp" %>
  <div class="popup_layout">
    <div class="topic_path">
      <a href ="<c:url value="ShopInfo.do"><c:param name="shopCd" value="${AspAddPageView.shopCd}"/></c:url>">
        店舗・契約詳細
      </a>&gt;
      <a href ="<c:url value="AspShopInfo.do"><c:param name="shopCd" value="${AspAddPageView.shopCd}"/></c:url>">
        不動産ASP設定情報
      </a>&gt;
        ${title}
    </div>
    ...
    <table class="type_detail_pre">
      ...
      <tr>
        <th>店舗名</th>
        <td>
          <c:out value="${AspAddPageView.company}" />
          <c:if test="${not empty AspAddPageView.company and not empty AspAddPageView.bumon}"> / </c:if>
          <c:out value="${AspAddPageView.bumon}" />
        </td>
      </tr>
      <tr>
        <th>店舗コード</th>
        <td><c:out value="${AspAddPageView.shopCd}"/></td>
      </tr>
      <tr>
        <th>お客様設定パスワード</th>
        <td><c:out value="${AspAddPageView.password}"/></td>
      </tr>
    </table>
    ...
    <html:form method="post" enctype="multipart/form-data" onsubmit="setSubmit();">
      <div class="add_form">
        ...
        <div class="form_space">
          <input type="text" name="title" value="${fn:escapeXml(AspAddPageView.title)}" size="50" maxlength="330">
        </div>
      </div>
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <label>
            <c:if test = "${AspAddPageView.layout == 'left' || AspAddPageView.layout == null }">
          ...
          <label>
            <c:if test = "${AspAddPageView.layout == 'center' }">
          ...
          <label>
            <c:if test = "${AspAddPageView.layout == 'right' }">
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <label>
            <c:if test = "${AspAddPageView.selectBoxType == '1' || AspAddPageView.selectBoxType == null }">
          ...
          <label>
            <c:if test = "${AspAddPageView.selectBoxType == '2' }">
          ...
          <br>
          <label>
            <c:if test = "${AspAddPageView.selectBoxType == '3' }">
          ...
          <label>
            <c:if test = "${AspAddPageView.selectBoxType == '4' }">
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <label>
            <c:if test = "${AspAddPageView.templateColor == 'gray' || AspAddPageView.templateColor == null }">
          ...
          <label>
            <c:if test = "${AspAddPageView.templateColor == 'yellow' }">
          ...
          <label>
            <c:if test = "${AspAddPageView.templateColor == 'purple' }">
          ...
          <label>
            <c:if test = "${AspAddPageView.templateColor == 'kimidori' }">
          ...
          <label>
            <c:if test = "${AspAddPageView.templateColor == 'red' }">
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <label>
            <c:if test = "${AspAddPageView.searchItem == '0' || AspAddPageView.searchItem == null }">
          ...
          <br>
          <label>
            <c:if test = "${AspAddPageView.searchItem == '1' }">
          ...
          <br>
          <label>
            <c:if test = "${AspAddPageView.searchItem == '2' }">
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <label>
            <c:if test = "${AspAddPageView.logoFlg == '0' || AspAddPageView.logoFlg == null }">
          ...
          <label>
            <c:if test = "${AspAddPageView.logoFlg == '1' }">
          ...
          <input type="file" size="60" name="logoFlgImage" value="${AspAddPageView.imgRealPath}${AspAddPageView.imgFileNm}" accept="image/jpeg">
          <script>
            $(function(){
      ...
      <div class="add_form">
        ...
        <div class="form_space">
          <label>
            <c:if test = "${AspAddPageView.policyFlg == '0' || AspAddPageView.policyFlg == null }">
          ...
          <label>
            <c:if test = "${AspAddPageView.policyFlg == '1' }">
          ...
          <c:if test = "${AspAddPageView.policyUrl == null }">
            <input type="text" size="60" maxlength="1024" name="policyUrl" value="http://">
          </c:if>
          <c:if test = "${AspAddPageView.policyUrl != null }">
            <input type="text" size="60" maxlength="1024" name="policyUrl" value="${fn:escapeXml(AspAddPageView.policyUrl)}">
          </c:if>
        </div>
      </div>
      ...
      <table class="type_asp">
        <c:forEach items="${AspAddPageView.aspAreaPrefInfoList}" var="aspAreaPrefInfo" varStatus="i">
          <tr>
      ...
      <table class="type_asp">
        <tr>
          <td>
            ...
            <input type="text" name="ensenCd1" value="${fn:escapeXml(AspAddPageView.ensenCd1)}" size="1" maxlength="1" >
          </td>
          <td>
            <chintai:CodePrint nameKey="SHOPBUKKEN_ENSENTYPE_NAME" valueKey="SHOPBUKKEN_ENSENTYPE_VALUE" code="2"/>
            <input type="text" name="ensenCd2" value="${fn:escapeXml(AspAddPageView.ensenCd2)}" size="1" maxlength="1" >
          </td>
          <td>
            <chintai:CodePrint nameKey="SHOPBUKKEN_ENSENTYPE_NAME" valueKey="SHOPBUKKEN_ENSENTYPE_VALUE" code="3"/>
            <input type="text" name="ensenCd3" value="${fn:escapeXml(AspAddPageView.ensenCd3)}" size="1" maxlength="1" >
          </td>
        </tr>
      </table>
      <p>
        <input type="hidden" name="company" value="${fn:escapeXml(AspAddPageView.company)}">
        <input type="hidden" name="bumon" value="${fn:escapeXml(AspAddPageView.bumon)}">
        <input type="hidden" name="shopCd" value="${fn:escapeXml(AspAddPageView.shopCd)}">
        <input type="hidden" name="password" value="${fn:escapeXml(AspAddPageView.password)}">
        <input type="hidden" name="shopKanriUpdDt" value="${fn:escapeXml(AspAddPageView.shopKanriUpdDt)}">
        <input type="hidden" name="imgRealPath" value="${fn:escapeXml(AspAddPageView.imgRealPath)}">
        <input type="hidden" name="imgUrlPath" value="${fn:escapeXml(AspAddPageView.imgUrlPath)}">
        <input type="hidden" name="imgFileNm" value="${fn:escapeXml(AspAddPageView.imgFileNm)}">
        <input type="hidden" name="imgKbn" value="${fn:escapeXml(AspAddPageView.imgKbn)}">
        <input type="hidden" name="imgFileType" value="${fn:escapeXml(AspAddPageView.imgFileType)}">
        <input type="hidden" name="imgId" value="${fn:escapeXml(AspAddPageView.imgId)}">
        <input type="hidden" name="prefs">
        <input type="submit" value="確認画面へ">
        <input type="button" value="戻る" onClick="_submit('AspAddPageBack.do');">
      </p>
    </html:form>
  </div>
</div>
