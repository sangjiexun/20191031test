...
<c:set var="title" value="${keiyakuName}更新確認" />
...
<%@ include file="../parts/PopUpContentsHeadline.jsp" %>
  <div class="popup_layout">
    ...
    <html:form action="/shop_bukken/ContractUpdateCommit.do" onsubmit="disableSubmit(this);">
      <div class="add_from">
      ...
      <input type="button" name="backButton" value="戻る" onclick="_submit('ContractUpdatePageBack.do')">
      </div>
    </html:form>
  </div>
</div>
