...
<c:set var="title" value="${ContractAmountAddView.keiyakuName}登録" />
...
<%@ include file="../parts/PopUpContentsHeadline.jsp" %>
  ...
  <html:form action="shop_bukken/ContractAmountAddConfirm.do" onsubmit="setSubmit();">
    <div class="add_form">
      <div class="add_form_title">契約期間</div>
      <div class="annotation">
      契約期間を選択します。契約終了日時を指定しない場合、無期限となります。<br/>
      契約開始日時は最新でなければなりません。 <br/>
      既に予約がある場合は削除後に登録してください。
      </div>
      <div class="form_space">
        ...
        <chintai:DateTag name="keiyakuStartHour"  fixValue="${view.keiyakuStartHour}"   type="time" /> 時<span class="caution">*</span> ～
        契約終了日時
