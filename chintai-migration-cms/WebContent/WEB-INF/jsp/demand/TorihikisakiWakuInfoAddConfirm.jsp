...
<%@ include file="../parts/PopUpContentsHeadline.jsp" %>
  <div class="popup_layout">
    ...
    <html:form action="demand/TorihikisakiWakuInfoAddCommit.do" onsubmit="disableSubmit(this);">
      <div class="add_from">
        ...
        <input type="button" name="backButton" value="戻る" onclick="_submit('TorihikisakiWakuInfoAddPage.do')">
      </div>
    </html:form>
  </div>
</div>
