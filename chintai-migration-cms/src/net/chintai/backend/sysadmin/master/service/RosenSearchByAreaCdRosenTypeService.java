 ...
 */
public interface RosenSearchByAreaCdRosenTypeService {
     ...
     * @throws Exception
     */
    public List<RosenSearchOutServiceBean> rosenSearchByAreaCdRosenType(RosenSearchInServiceBean inServiceBean)
            throws Exception;
