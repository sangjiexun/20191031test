/*
 * $Id: RosenSearchView.java 4062 2008-11-12 05:49:12Z m-ono $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 *          Reserved.
 */
public class RosenSearchView implements ViewHelper {
    ...
    /** 沿線検索結果リスト */
    private List<RosenSearchDetailView> rosenSearchList;
     ...
     */
    public void setRosenSearchList(List<RosenSearchDetailView> rosenSearchList) {
     ...
     * @return 沿線検索結果リスト
     */
    public List<RosenSearchDetailView> getRosenSearchList() {
        return rosenSearchList;
    }

    public class RosenSearchDetailView {
