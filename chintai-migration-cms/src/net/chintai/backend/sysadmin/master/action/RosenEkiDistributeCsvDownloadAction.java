/*
 * $Id: RosenEkiDistributeCsvDownloadAction.java 3714 2007-12-26 06:23:19Z t-kojima $
 * ---------------------------------------------------------
 * 更新日       更新者        内容
 * ---------------------------------------------------------
...
/**
 * 配布用の駅CSVをダウンロードするアクション。
 *
 * @author KOJIMA Takanori
 * @version $Revision: 3714 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class RosenEkiDistributeCsvDownloadAction extends BaseActionSupport {

    private static Log log = LogFactory.getLog(RosenEkiDistributeCsvDownloadAction.class);
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        if(rosenEkiSearchForCsvList.size() > 0){
	        ...
	        // CSV出力処理
	        try {
	            service.createEkiCsv(csvStatusBean);
    ...
    private String getCsvFileName() {
        return SystemProperties.getProperty("RosenEki.DistributeEkiCsv");
    }
}
