/*
 * $Id: ReviewBukkenStatusUpdateView.java 3905 2008-05-27 05:51:09Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 物件対象外設定機能画面ViewHelper
 * @author Lee Hosup
 * @version $Revision: 3905 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ReviewBukkenStatusUpdateView implements ViewHelper {
	/** 部屋キー */
