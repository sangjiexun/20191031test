/*
 * $Id: ReviewShopSearchPageAction.java 3593 2007-12-17 04:31:16Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
...
/**
 * Web審査店舗検索ページを提供するクラス。<br>
 * @author lee-hosup
 * @version $Revision: 3593 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ReviewShopSearchPageAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        // 「審査情報から検索」のチェックボックス設定用
        context.getRequest().setAttribute("defaultFlag", "on");

        context.getSessionBean().getSearchConditionMap().remove(
                SessionSearchKey.REVIEW_SHOP_SEARCH);

        DynaValidatorForm form = (DynaValidatorForm)context.getForm();
        ReviewShopSearchView view = new ReviewShopSearchView(new BasePagerCondition());
