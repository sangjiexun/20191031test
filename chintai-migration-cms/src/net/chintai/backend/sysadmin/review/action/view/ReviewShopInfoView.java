/*
 * $Id: ReviewShopInfoView.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 店舗詳細画面出力用。<br>
 * この ViewHelper は、店舗/物件管理機能の店舗詳細 ViewHelper を再利用しています。
 * 
 * @author Lee Hosup
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ReviewShopInfoView extends ShopDetailInfoSearchView {
