/*
 * $Id: ReviewShopStatusUpdateConfirmAction.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 */
public class ReviewShopStatusUpdateConfirmAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        if (!(view.getSyokaiShinsaSkipFlg().equals("1"))) {
            view.setSyokaiShinsaSkipFlg("0");
        }
        if (!(view.getTeikiShinsaSkipFlg().equals("1"))) {
            view.setTeikiShinsaSkipFlg("0");
        }
        if (!(view.getMailSendSkipFlg().equals("1"))) {
            view.setMailSendSkipFlg("0");
        }
        if (!(view.getAutoDelSkipFlg().equals("1"))) {
            view.setAutoDelSkipFlg("0");
        }
