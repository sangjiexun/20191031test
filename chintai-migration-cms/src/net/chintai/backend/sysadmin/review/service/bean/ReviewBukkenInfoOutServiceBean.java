/*
 * $Id: ReviewBukkenInfoOutServiceBean.java 3912 2008-05-27 08:06:03Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class ReviewBukkenInfoOutServiceBean {
    ...
    /** 審査履歴リスト */
    private List<ReviewBukkenInfoOutServiceDetailBean> rirekiList;
    ...
    public class ReviewBukkenInfoOutServiceDetailBean {
     ...
     * @return 審査履歴リスト
     */
    public List<ReviewBukkenInfoOutServiceDetailBean> getRirekiList() {
        return rirekiList;
    }

    /**
     * 審査履歴リストを設定します。
     * @param rirekiList 審査履歴リスト
     */
    public void setRirekiList(List<ReviewBukkenInfoOutServiceDetailBean> rirekiList) {
