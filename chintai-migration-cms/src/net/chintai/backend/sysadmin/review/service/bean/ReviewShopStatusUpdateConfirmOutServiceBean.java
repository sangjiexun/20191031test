/*
 * $Id: ReviewShopStatusUpdateConfirmOutServiceBean.java 3912 2008-05-27 08:06:03Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
...
/**
 * 店舗対象外設定変更確認画面に表示する店舗情報
 *
 * @author lee-hosup
 * @version $Revision: 3912 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ReviewShopStatusUpdateConfirmOutServiceBean {
