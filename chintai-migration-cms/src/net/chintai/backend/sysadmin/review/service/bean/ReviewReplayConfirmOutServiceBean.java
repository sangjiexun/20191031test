/*
 * $Id: ReviewReplayConfirmOutServiceBean.java 4325 2009-08-03 04:13:56Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 * 2007/10/22  BGT)李昊燮   新規作成
 * 2009/08/03  BGT)李昊燮   物件詳細の所要時間と 各金額の単位表示方法修正対応
 *
 */
 ...
 *
 * @author lee-hosup
 * @version $Revision: 4325 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ReviewReplayConfirmOutServiceBean {
