/*
 * $Id: ReviewShopMediaCountDomain.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class ReviewShopMediaCountDomain {

    /** 店舗別出稿状況集計 */
    private List shopMediaCntList;
     ...
     * @return 店舗別出稿状況集計
     */
    public List getShopMediaCntList() {
        return shopMediaCntList;
    }

    /**
     * 店舗別出稿状況集計を設定します。
     * @param shopMediaCntList 店舗別出稿状況集計
     */
    public void setShopMediaCntList(List shopMediaCntList) {
