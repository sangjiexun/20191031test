/*
 * $Id: ReviewBukkenWebStatusUpdateDomain.java 3911 2008-05-27 07:09:06Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class ReviewBukkenWebStatusUpdateDomain {
	/** 部屋キー */
	...
	/**
	 * @param syokaiAutoDelDt セットする syokaiAutoDelDt
	 */
	...
	/**
	 * @param teikiAutoDelDt セットする teikiAutoDelDt
	 */
