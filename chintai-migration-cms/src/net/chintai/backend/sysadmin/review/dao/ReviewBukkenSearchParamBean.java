/*
 * $Id: ReviewBukkenSearchParamBean.java 3910 2008-05-27 06:56:09Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 * 2007/10/09  BGT)李昊燮   新規作成
 * 2008/05/21  BGT)李昊燮   連続掲載日数（上限下限）、有効なテーブル名項目追加
 */
 ...
 */
public class ReviewBukkenSearchParamBean {
