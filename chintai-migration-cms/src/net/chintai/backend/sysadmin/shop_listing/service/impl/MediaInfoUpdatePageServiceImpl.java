/*
 * $Id: MediaInfoUpdatePageServiceImpl.java 4324 2009-08-03 04:13:24Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * MediaInfoUpdatePageServiceの実装クラス。
 *
 * @author Lee Hosup
 * @version $Revision: 4324 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class MediaInfoUpdatePageServiceImpl implements MediaInfoUpdatePageService {
     ...
     *
     * @see
     * net.chintai.backend.sysadmin.shop_listing.service.MediaInfoUpdatePageService
     * # searchMediaInfo(java.lang.String)
     */
    public MediaInfoUpdatePageOutServiceBean searchMediaInfo(String shopCd) {

        // 戻り値
        MediaInfoUpdatePageOutServiceBean outBean = new MediaInfoUpdatePageOutServiceBean();
