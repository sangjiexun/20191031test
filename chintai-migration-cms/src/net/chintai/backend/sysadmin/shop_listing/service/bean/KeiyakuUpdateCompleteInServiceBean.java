/*
 * $Id: KeiyakuUpdateCompleteInServiceBean.java 4284 2009-07-06 12:25:15Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 */
public class KeiyakuUpdateCompleteInServiceBean {
    ...
    /** 契約種別:変更前 */
    private String keiyakuShubetsuBefore;
    ...
    /** 店舗リスティング契約情報テーブルの最終更新日 */
    private String shopListingKeiyakuUpdDt;
     ...
     * @return 契約種別:変更前
     */
    public String getKeiyakuShubetsuBefore() {
        return keiyakuShubetsuBefore;
    }

    /**
     * 契約種別:変更前を設定します。
     * @param keiyakuShubetsuBefore 契約種別:変更前
     */
    public void setKeiyakuShubetsuBefore(String keiyakuShubetsuBefore) {
        this.keiyakuShubetsuBefore = keiyakuShubetsuBefore;
    }
    ...
    /**
     * 店舗リスティング契約情報テーブルの最終更新日を取得します。
     * @return 店舗リスティング契約情報テーブルの最終更新日
     */
    public String getShopListingKeiyakuUpdDt() {
        return shopListingKeiyakuUpdDt;
    }

    /**
     * 店舗リスティング契約情報テーブルの最終更新日を設定します。
     * @param shopListingKeiyakuUpdDt 店舗リスティング契約情報テーブルの最終更新日
     */
    public void setShopListingKeiyakuUpdDt(String shopListingKeiyakuUpdDt) {
        this.shopListingKeiyakuUpdDt = shopListingKeiyakuUpdDt;
    }
