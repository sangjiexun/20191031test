/*
 * $Id: KeiyakuRegisterCompleteInServiceBean.java 4284 2009-07-06 12:25:15Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 契約情報登録完了InServiceBean。
 *
 * @author Lee Hosup
 * @version $Revision: 4284 $ Copyright:
 * (C) CHINTAI Corporation All Right Reserved.
 */
public class KeiyakuRegisterCompleteInServiceBean {
