/*
 * $Id: MediaInfoRegisterWebInfoCopyAction.java 4246 2009-03-23 09:00:00Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 現在WEB掲載中の出稿情報を出稿情報登録画面にコピーするアクション
 *
 * @author Lee Hosup
 * @version $Revision: 4246 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class MediaInfoRegisterWebInfoCopyAction extends BaseActionSupport {
