/*
 * $Id: CouponEditView.java 4242 2009-03-23 04:52:37Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 * 2009/03/04     BGT)李昊燮     新規作成
 *
 */
package net.chintai.backend.sysadmin.shop_listing.action.view;

/**
 * クーポン情報編集画面ViewHelper
 *
 * @author Lee Hosup
 * @version $Revision: 4242 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class CouponEditView extends ShopBasicInfoView {
     ...
     * @param displayLimit
     */
    public CouponEditView(String displayLimit) {
        this.displayLimit = displayLimit;
    }

    /**
     * 画面に表示する入力フォームの数を取得します。
     * @return 画面に表示する入力フォームの数
     */
    ...
    /**
     * 画面に表示する入力フォームの数を設定します。
     * @param displayLimit 画面に表示する入力フォームの数
     */
