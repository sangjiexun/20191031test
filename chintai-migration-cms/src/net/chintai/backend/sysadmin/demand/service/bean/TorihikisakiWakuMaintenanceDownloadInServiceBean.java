/*
 * $Id: TorihikisakiWakuMaintenanceDownloadInServiceBean.java 4664 2013-10-09 08:38:48Z t-kameda $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 物件枠数・物件リスティング枠数のCSVダウンロード用InServiceBean
 * @author KAMEDA Takuma
 * @version $Revision: 4664 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class TorihikisakiWakuMaintenanceDownloadInServiceBean {
