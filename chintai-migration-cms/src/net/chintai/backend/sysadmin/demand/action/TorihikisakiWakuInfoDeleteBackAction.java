/*
 * $Id: TorihikisakiWakuInfoDeleteBackAction.java 3850 2008-03-10 05:40:33Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 * 2007/12/12  BGT)李昊燮   新規作成
 *
 */
 ...
 */
public class TorihikisakiWakuInfoDeleteBackAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        List<TorihikisakiWakuInfoOutServiceBean> wakuList =
                (List<TorihikisakiWakuInfoOutServiceBean>) wakuInfoService
                        .getTorihikisakiWakuInfo(wakuInBean);
        ...
        for (int i=0; i < wakuList.size(); i++) {
            ...
            if (delFlgList.contains(detailView.getStartYm())) {
