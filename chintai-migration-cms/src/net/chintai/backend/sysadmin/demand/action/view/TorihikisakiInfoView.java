/*
 * $Id: TorihikisakiInfoView.java 3576 2007-12-14 11:39:18Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class TorihikisakiInfoView implements ViewHelper {
    ...
    /** 物件枠情報リスト */
    private List<TorihikisakiInfoDetailView> wakuInfoList;

    // 物件枠情報格納用InnerClass
    public class TorihikisakiInfoDetailView {
        ...
        /**
         * 削除チェックボックス状態フラグを取得します。
         * @return 削除チェックボックス状態フラグ
         */
        ...
        /**
         * 削除チェックボックス状態フラグを設定します。
         * @param checkFlg 削除チェックボックス状態フラグ
         */
     ...
     * @return 物件枠情報リスト
     */
    public List<TorihikisakiInfoDetailView> getWakuInfoList() {
        return wakuInfoList;
    }
     ...
     */
    public void setWakuInfoList(List<TorihikisakiInfoDetailView> wakuInfoList) {
