/*
 * $Id: TorihikisakiWakuInfoAddView.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class TorihikisakiWakuInfoAddView implements ViewHelper {
	...
	/**
	 * 取引先テーブルの更新日付を設定します。
	 * @param torihikisakiUpdDt 取引先テーブルの更新日付
	 */
