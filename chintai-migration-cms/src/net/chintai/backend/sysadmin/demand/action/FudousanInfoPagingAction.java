/*
 * $Id: FudousanInfoPagingAction.java 3850 2008-03-10 05:40:33Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 */
public class FudousanInfoPagingAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        // 不動産会社情報を検索
        FudousanInfoOutServiceBean outBean = fudousanInfoService.fudousanInfo(inServiceBean);
