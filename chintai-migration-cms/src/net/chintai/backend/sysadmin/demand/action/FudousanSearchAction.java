/*
 * $Id: FudousanSearchAction.java 3676 2007-12-20 04:20:42Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class FudousanSearchAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        context.getSessionBean().getSearchConditionMap().put(SessionSearchKey.DEMAND_FUDOUSAN_SEARCH, inBean);
