/*
 * $Id: ShopBindUpdatePageAction.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class ShopBindUpdatePageAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        // 画面の表示形式に編集
        view.setTorihikisakiCd(outBean.getFudousanCd() + "-" + outBean.getTorihikisakiCd());

        String torihikisakiName = (outBean.getTorihikisakiName() == null)
                    ? outBean.getFudousanName()
                    : (outBean.getFudousanName() + outBean.getTorihikisakiName());
        view.setTorihikisakiName(torihikisakiName);
