...
/**
 * 物件枠管理機能のCSVアップロード処理についての共通ユーティリティクラス
 * @author KAMEDA Takuma
 * @version $Revision: 4650 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public final class DemandCsvUploadUtil {


    /** このクラスはインスタンス化できません。 */
    private DemandCsvUploadUtil() {
    }
    ...
    protected static boolean validateFileSuffix(String uploadFileName) {
        String csvSuffix = ApplicationResources.getProperty("demand.uploadFileExtensions");
