/*
 * $Id: TorihikisakiSearchPageAction.java 3593 2007-12-17 04:31:16Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class TorihikisakiSearchPageAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        context.getSessionBean().getSearchConditionMap().remove(
                SessionSearchKey.DEMAND_TORIHIKISAKI_SEARCH);

        // Validationに引っ掛かった場合のため
        DynaValidatorForm form = (DynaValidatorForm)context.getForm();
        TorihikisakiSearchView view = new TorihikisakiSearchView(new BasePagerCondition());
