/*
 * $Id: TorihikisakiSearchForBindView.java 3665 2007-12-20 01:42:42Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
 ...
 */
public class TorihikisakiSearchForBindView extends PagerViewHelper{
     ...
     * @param condition
     */
    public TorihikisakiSearchForBindView(PagerCondition condition) {
        super(condition);
    }

    // 検索結果格納用InnerClass
    public class TorihikisakiSearchForBindDetailView implements ViewHelper {
