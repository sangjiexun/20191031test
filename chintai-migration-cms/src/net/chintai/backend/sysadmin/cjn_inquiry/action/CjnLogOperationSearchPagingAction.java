/*
 * $Id: CjnLogOperationSearchPagingAction.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * システム操作履歴を検索するアクション(ページング用)。
 * 
 * @author KOJIMA Takanori
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class CjnLogOperationSearchPagingAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        // セッションから検索条件を取得
        CjnLogOperationSearchInServiceBean inServiceBean =
                (CjnLogOperationSearchInServiceBean) context.getSessionBean().getSearchConditionMap().get(
                        SessionSearchKey.CJN_LOGOPERATION);
