/*
 * $Id: CjnInquiryStatusUpdatePageBackAction.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 問い合せ処理状況更新ページBackアクション
 * 
 * @author Yang-EunMi
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class CjnInquiryStatusUpdatePageBackAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        if (!acl.isAccessibleForInqId(context.getSessionBean().getUserId(), form.getString("cjnInqId"))) {
