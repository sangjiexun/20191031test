/*
 * $Id: CjnInquiryStatusUpdatePageOutServiceBean.java 3990 2008-07-14 11:31:11Z s-sugimoto $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 * @version 2008.07.11 雑誌・ザガットクレジット対応のため、property追加<br>
 *          CjnInquirySearchOutServiceBean.javaとまったく同じなので、汎化したいと思う<br>
 * @version 2008.07.14 汎化した抽象クラスを継承するように変更した<br>
 *          Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class CjnInquiryStatusUpdatePageOutServiceBean extends AbstractCjnInquiryBaseServiceBean {
