...
import net.chintai.backend.sysadmin.common.tags.domain.MstRendoDomain;
 ...
 */
public class MstRendoTag extends TagSupport {

	private static final long serialVersionUID = 4179693889460828093L;
    ...
    public int doStartTag() throws JspException {
        ...
        List rsList = service.getMstRendo();

        // JSPに書き出す内容作成
        MstRendoDomain domain;
        String optionValue;
        String optionName;
        ...
        for (int i = 0; i < rsList.size(); i++) {
            domain = (MstRendoDomain) rsList.get(i);
            optionValue = String.valueOf(domain.getRendoCd());
            optionName = domain.getRendoName();
