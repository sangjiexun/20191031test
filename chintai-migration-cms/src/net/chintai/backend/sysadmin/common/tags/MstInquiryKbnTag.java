...
import net.chintai.backend.sysadmin.common.tags.domain.MstInquiryKbnDomain;

import org.apache.commons.lang.StringUtils;
import org.springframework.context.ApplicationContext;
import org.springframework.web.context.support.WebApplicationContextUtils;

public class MstInquiryKbnTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        List rsList = service.getMstInquiryKbn(inqKbnColName);

        // JSPに書き出す内容作成
        MstInquiryKbnDomain domain;
        String optionValue;
        String optionName;
        ...
        for (int i = 0; i < rsList.size(); i++) {
            domain = (MstInquiryKbnDomain) rsList.get(i);
            optionValue = String.valueOf(domain.getInqKbn());
            optionName = domain.getInqKbnName();
	...
	/**
	 * @param inqKbnColName セットする inqKbnColName
	 */
	public void setInqKbnColName(String inqKbnColName) {
		this.inqKbnColName = inqKbnColName;
	}
}
