/*
 * $Id: InquiryInfoTag.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者       内容
 * ---------------------------------------------------------
...
import net.chintai.backend.sysadmin.common.tags.domain.InquiryDomain;
...
/**
 * システム操作履歴検索 画面の検索条件プルダウン
 *
 * @author lee-hosup
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class InquiryInfoTag extends TagSupport {

    private static final long serialVersionUID = -776983861221372944L;
    ...
    public int doStartTag() throws JspException {
        ...
        List rsList = service.getInquiryInfo();
        ...
        for (int i = 0; i < rsList.size(); i++) {
            domain = (InquiryDomain) rsList.get(i);
            optionValue = String.valueOf(domain.getInqKindSeq());
            optionName = domain.getInqTitle();
