 ...
 */
public class ShopListingAddConfirmParamBean {
    /** 店舗コード  */
	...
	public String getNoValueEndDt() {
		return noValueEndDt;
	}

	public void setNoValueEndDt(String noValueEndDt) {
		this.noValueEndDt = noValueEndDt;
	}
