/*
 * $Id: ShopSearchParamBean.java 3762 2008-01-21 06:58:31Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 */
public class ShopSearchParamBean {
	...
	private List<Map.Entry<KeiyakuKey, String>> shopKeiyakusEntries = new ArrayList<>();

	public static final class KeiyakuKey {
		...
		/**
		 * @param keiyakuCd the keiyakuCd to set
		 */
		...
		/**
		 * @param keiyakuSubCd the keiyakuSubCd to set
		 */
	...
	/**
	 * @return shopKeiyakusEntries
	 */
	public List<Map.Entry<KeiyakuKey, String>> getShopKeiyakusEntries() {
		return shopKeiyakusEntries;
	}

	/**
	 * @param shopKeiyakusEntries the shopKeiyakusEntries to set
	 */
	public void setShopKeiyakusEntries(List<Map.Entry<KeiyakuKey, String>> shopKeiyakusEntries) {
		this.shopKeiyakusEntries = shopKeiyakusEntries;
	}
