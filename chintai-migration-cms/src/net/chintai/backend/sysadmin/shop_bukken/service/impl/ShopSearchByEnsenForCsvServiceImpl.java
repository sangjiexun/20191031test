/*
 * $Id: ShopSearchByEnsenForCsvServiceImpl.java 3835 2008-02-27 04:09:23Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * ShopSearchByEnsenForCsvServiceの実装クラス
 * 
 * @author Sim-JongYeon
 * @version $Revision: 3835 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ShopSearchByEnsenForCsvServiceImpl implements ShopSearchByEnsenForCsvService {
    ...
    /*
     * (非 Javadoc)
     * @see net.chintai.backend.sysadmin.shop_bukken.service.ShopSearchByEnsenForCsvService#shopSearchByEnsenForCsv(net.chintai.backend.sysadmin.shop_bukken.service.bean.ShopSearchInServiceBean)
     */
    public List<ShopSearchOutServiceBean> shopSearchByEnsenForCsv(ShopSearchInServiceBean inServiceBean) {
        ...
        // 沿線から検索
        List rsList = shopSearchDao.selectShopSearchByEnsenForCsv(paramBean);
