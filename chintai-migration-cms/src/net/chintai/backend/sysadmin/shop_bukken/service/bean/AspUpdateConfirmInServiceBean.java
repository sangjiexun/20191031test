/*
 * $Id: AspUpdateConfirmInServiceBean.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 不動産ASP設定情報更新確認画面用InServiceBean
 *
 * @author Sim-JongYeon
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class AspUpdateConfirmInServiceBean {
    ...
    /** 会社ロゴ画像ファイル形式 */
    private String logoFlgType;

    /** 会社ロゴ画像ファイル */
    private String logoFlgImage;

    /** アップロードされた画像ファイルのURLパス */
    ...
    /**
     * 会社ロゴ画像ファイル形式を設定します。
     * @param logoFlgType 会社ロゴ画像ファイル形式
     */
    public void setLogoFlgType(String logoFlgType) {
        this.logoFlgType = logoFlgType;
    }
    ...
    /**
     * アップロードされた画像ファイルのURLパスを設定します。
     * @param logoFlgUrlPath アップロードされた画像ファイルのURLパス
     */
    ...
    /**
     * アップロードされた画像ファイルのURLパスを取得します。
     * @return アップロードされた画像ファイルのURLパス
     */
    ...
    /**
     * 不動産ASP設定の最終更新日付を設定します。
     * @param updDt 不動産ASP設定の最終更新日付
     */
    ...
    /**
     * 不動産ASP設定の最終更新日付を取得します。
     * @return 不動産ASP設定の最終更新日付
     */
