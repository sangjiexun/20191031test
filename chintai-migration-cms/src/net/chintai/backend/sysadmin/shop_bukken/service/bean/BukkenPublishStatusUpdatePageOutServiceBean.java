/*
 * $Id: BukkenPublishStatusUpdatePageOutServiceBean.java 4535 2011-11-04 05:46:53Z e-ishii $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 物件掲載状態変更画面に遷移OutServiceBean
 *
 * @author Kim Dong Jin
 * @version $Revision: 4535 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class BukkenPublishStatusUpdatePageOutServiceBean {
