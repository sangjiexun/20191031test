/*
 * $Id: ShopSearchByAreaServiceImpl.java 3835 2008-02-27 04:09:23Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * ShopSearchByAreaServiceの実装クラス
 * 
 * @author Sim-JongYeon
 * @version $Revision: 3835 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ShopSearchByAreaServiceImpl implements ShopSearchByAreaService {
    ...
    /*
     * (非 Javadoc)
     * @see net.chintai.backend.sysadmin.shop_bukken.service.ShopSearchByAreaService#shopSearchByArea(net.chintai.backend.sysadmin.shop_bukken.service.bean.ShopSearchInServiceBean)
     */
    public List<ShopSearchOutServiceBean> shopSearchByArea(ShopSearchInServiceBean inServiceBean, BasePagerCondition condition) {
        ...
        // 店舗情報から検索の結果件数
        int resultCount = shopSearchDao.selectShopSearchByAreaCount(paramBean);
        ...
        // エリアから検索
        List rsList = shopSearchDao.selectShopSearchByArea(paramBean, condition);
