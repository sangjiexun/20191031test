 ...
 */
public class ShopListingUpdateView implements ViewHelper {
    ...
    /** 停止時の終了日時表示*/
    private String stopKeiyakuDate;
     ...
     * @return 停止時の終了日時表示
     */
    public String getStopKeiyakuDate() {
        return stopKeiyakuDate;
    }

    /**
     * 停止時の終了日時表示を設定します。
     * @param stopKeiyakuDate  停止時の終了日時表示
     */
    public void setStopKeiyakuDate(String stopKeiyakuDate) {
        this.stopKeiyakuDate = stopKeiyakuDate;
    }
