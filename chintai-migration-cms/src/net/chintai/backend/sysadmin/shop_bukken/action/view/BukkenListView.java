/*
 * $Id: BukkenListView.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 */
public class BukkenListView implements ViewHelper {

    /** 物件リスト */
    private List<BukkenListDetailView> bukkenList;
     ...
     * @return 物件リスト
     */
    public List<BukkenListDetailView>  getBukkenList() {
        return bukkenList;
    }

    /**
     * 物件リストを設定します。
     * @param bukkenList 物件リスト
     */
    public void setBukkenList(List<BukkenListDetailView>  bukkenList) {
    ...
    public class BukkenListDetailView
    {
    	/** 部屋キー */
