 ...
 */
public class ContractAmountDeleteCommitAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        ContractAmountDeleteCommitInServiceBean inBean =
                new ContractAmountDeleteCommitInServiceBean();
        ...
        ContractAmountDeleteCommitService service =
                (ContractAmountDeleteCommitService) ac
                        .getBean("contractAmountDeleteCommitService");
        ...
        try {
            ...
            context.setMessage("INFO.M.SHOP_BUKKEN.0019", form.getString("keiyakuName"));
