/*
 * $Id: ShopImageDeleteConfirmView.java 4295 2009-07-07 12:59:59Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
 ...
 */
public class ShopImageDeleteConfirmView implements ViewHelper {
    ...
    /**
     * 店舗地図の削除フラグを設定します。
     * @param shopMapPctFileDeleteCheck 店舗地図の削除フラグ
     */
    ...
    /**
     * 店舗画像３(店内写真)パスを設定します。
     * @param shopPhoto3FilePath 店舗画像３(店内写真)パス
     */
    ...
    /**
     * 店舗画像４(スタッフ接客写真)パスを取得します。
     * @return 店舗画像４(スタッフ接客写真)パス
     */
    ...
    /**
     * 店舗画像４(スタッフ接客写真)パスを設定します。
     * @param shopPhoto4FilePath 店舗画像４(スタッフ接客写真)パス
     */
