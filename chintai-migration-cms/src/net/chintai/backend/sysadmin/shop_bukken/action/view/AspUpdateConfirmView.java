/*
 * $Id: AspUpdateConfirmView.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 不動産ASP設定情報更新確認画面用ViewHelper
 *
 * @author Sim-JongYeon
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class AspUpdateConfirmView implements ViewHelper {
    ...
    /**
     * 不動産ASP設定情報の最終更新日付を取得します。
     * @return 不動産ASP設定情報の最終更新日付
     */
    ...
    /**
     * 不動産ASP設定情報の最終更新日付を設定します。
     * @param updDt 不動産ASP設定情報の最終更新日付
     */
