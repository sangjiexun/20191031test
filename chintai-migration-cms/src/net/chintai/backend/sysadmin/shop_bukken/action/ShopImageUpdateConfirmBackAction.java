/*
 * $Id: ShopImageUpdateConfirmBackAction.java 4302 2009-07-13 05:54:31Z lee-hosup $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 店舗画像更新確認画面の店舗画像更新画面に戻るアクション
 *
 * @author Sim-JongYeon
 * @version $Revision: 4302 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class ShopImageUpdateConfirmBackAction extends BaseActionSupport {
    ...
    protected void doExecute(BusinessContext context) throws Exception {
        ...
        view.setEditedMapPctComment(form.getString("editedMapPctComment"));
        view.setEditedPhoto1Comment(form.getString("editedPhoto1Comment"));
        view.setEditedPhoto2Comment(form.getString("editedPhoto2Comment"));
        view.setEditedPhoto3Comment(form.getString("editedPhoto3Comment"));
        view.setEditedPhoto4Comment(form.getString("editedPhoto4Comment"));
