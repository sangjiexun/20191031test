/*
 * $Id: AspAddConfirmView.java 3570 2007-12-14 08:55:47Z t-kojima $
 * ---------------------------------------------------------
 * 更新日      更新者         内容
 * ---------------------------------------------------------
...
/**
 * 不動産ASP設定情報登録確認画面用ViewHelper
 *
 * @author Sim-JongYeon
 * @version $Revision: 3570 $
 * Copyright: (C) CHINTAI Corporation All Right Reserved.
 */
public class AspAddConfirmView implements ViewHelper {
    ...
    /** 沿線設定 */
    private List<EnsenTypeListView> ensenTypeList;
     ...
     * @return 沿線設定
     */
    public List<EnsenTypeListView> getEnsenTypeList() {
     ...
     */
    public void setEnsenTypeList(List<EnsenTypeListView> ensenTypeList) {
     ...
     * @author KOJIMA Takanori
     */
    public class EnsenTypeListView {
